...
namespace model
{
    ...
    struct DislocatedMaterialBase
    {
        ...
        // Material constants for dislocation nucleation
        double alpha;
        double sigma_th;
...
//        const double c0;        // shear wave speed [-]
        ...
        /* init */,alpha(TextFileParser(materialFile).readScalar<double>("alpha",true))
        /* init */,sigma_th(TextFileParser(materialFile).readScalar<double>("sigma_th",true))
