...
//                ss.clear();
                ...
                for(size_t k=0;k<sizeL;++k)
                {
                    ...
                    ss.clear();
                    if (loops().back().loopType == 2)
                    {
                        virtualLoopID.emplace(loops().back().sID);
                        loops().pop_back();
                    }
                }
                ...
                for(size_t k=0;k<sizeE;++k)
                {
                    ...
                    ss.clear();
                    if ( virtualLoopID.count(links().back().loopID) )
                    {
                        links().pop_back();
                    }
                }
